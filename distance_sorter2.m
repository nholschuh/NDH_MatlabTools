function varargout = distance_sorter2(xy,dmat,popSize,numIter,showProg,showResult)
...
% [optRoute,minDist] = distance_sorter2(xy,dmat,popSize,numIter,showProg,showResult);
%
% Example:
%     n = 100;
%     phi = (sqrt(5)-1)/2;
...
for iter = 1:numIter
    ...
    if showProg == 0 & mod(iter,round(numIter/10)) == 0
            disp(['Completed ',num2str((iter/numIter)*100),'% of iterations'])
    end
