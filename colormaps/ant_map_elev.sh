...
grid=./Dropbox/Matlab_Code/NDH_Tools/Bedmap2_bed.grd
...
grdimage $grid -Celevation.cpt $J -Q -O -K $Rm >> $mapname

psscale -B500 -Celevation_scale.cpt -E -O -D5.25i/2.5i/5i/0.125i >> $mapname
