function    grdpaint(grid1,outputname,overlay)
...
while i == 1
    ...
    if contour_storage(i,3) < 4
        ...
        gridz(yi+1,xi) = gridz(yi+1,xi) - .8525*reduction_scalar*ud;        
        gridz(yi-1,xi) = gridz(yi-1,xi) - .8525*reduction_scalar*ud;
        gridz(yi,xi+1) = gridz(yi,xi+1) - .8525*reduction_scalar*ud;        
        gridz(yi,xi-1) = gridz(yi,xi-1) - .8525*reduction_scalar*ud;
        
        gridz(yi+2,xi) = gridz(yi+2,xi) - .34*reduction_scalar*ud;
        gridz(yi-2,xi) = gridz(yi-2,xi) - .34*reduction_scalar*ud;
        gridz(yi,xi+2) = gridz(yi,xi+2) - .34*reduction_scalar*ud;
        gridz(yi,xi-2) = gridz(yi,xi-2) - .34*reduction_scalar*ud;
        gridz(yi+1,xi+1) = gridz(yi+1,xi+1) - .34*reduction_scalar*ud;
        gridz(yi+1,xi-1) = gridz(yi+1,xi-1) - .34*reduction_scalar*ud;
        gridz(yi-1,xi+1) = gridz(yi-1,xi+1) - .34*reduction_scalar*ud;
        gridz(yi-1,xi-1) = gridz(yi-1,xi-1) - .34*reduction_scalar*ud;
        
        
        gridz(yi+2,xi+1) = gridz(yi+2,xi+1) - .0525*reduction_scalar*ud;
        gridz(yi+2,xi-1) = gridz(yi+2,xi-1) - .0525*reduction_scalar*ud;
        gridz(yi-2,xi+1) = gridz(yi-2,xi+1) - .0525*reduction_scalar*ud;
        gridz(yi-2,xi-1) = gridz(yi-2,xi-1) - .0525*reduction_scalar*ud;
        gridz(yi+1,xi+2) = gridz(yi+1,xi+2) - .0525*reduction_scalar*ud;
        gridz(yi+1,xi-2) = gridz(yi+1,xi-2) - .0525*reduction_scalar*ud;
        gridz(yi-1,xi+2) = gridz(yi-1,xi+2) - .0525*reduction_scalar*ud;
        gridz(yi-1,xi-2) = gridz(yi-1,xi-2) - .0525*reduction_scalar*ud;
