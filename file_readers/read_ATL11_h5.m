function [output startind endind]=read_ATL11_h5(h5_file,subset_flag,startind,endind,addedfields)
...
keep_vars = {'h_corr','delta_time','quality_summary','latitude','longitude','ref_pt','dem_h','start_rgt'};
...
for i = 1:length(I.Groups)
    if I.Groups(i).Name(2) == 'p' & (subset_flag == 1 | subset_flag == 2)
        subset_group(i) = 1;
        rn = I.Groups(i).Name;
        segids = h5read(h5_file,['/',rn,'/ref_pt']);
