function [x,y]=polarstereo_fwd(phi,lambda,ant0_gre1_gre45,a,e,phi_c,lambda_0)
...
%       (default is -71). Note that some NSIDC data use 70 and some use 71.
...
%   Modified by Nick Holschuh, 05/01/2014
...
%%%%%%%%%% Here we set the defaults for the transformation
if exist('ant0_gre1_gre45') == 0
    if min(phi) > 0 %%%%%%%%% Northern Hemisphere
        ant0_gre1_gre45 = 2; %%%% This sets the default Greenland projection to -45, 70
    else
        ant0_gre1_gre45 = 0; %%%% This sets the Antarctica projection
    end
end
...
% Define the Standard Parallel for Greenland and Antarctica
% (This is the latitude of true scale
if nargin < 6 || isempty(phi_c)
    if ant0_gre1_gre45 == 0
        phi_c=-71; %Antarctica
    elseif ant0_gre1_gre45 == 1
        phi_c=71; %Greenland
    elseif ant0_gre1_gre45 == 2
        phi_c=70; %Greenland2
    end
end
% Here we define the straight longitude line for the maps
if nargin < 7 || isempty(lambda_0)
    if ant0_gre1_gre45 == 0
        lambda_0=0; %Antarctica
    elseif ant0_gre1_gre45 == 1
        lambda_0=-39; %Greenland
    elseif ant0_gre1_gre45 == 2
        lambda_0=-45; %Greenland2
    end
end
