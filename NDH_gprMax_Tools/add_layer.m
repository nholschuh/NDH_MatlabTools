function add_layer(filename,depth_to_top,thickness,perm_and_cond)
...
fprintf(fid,['#box: %.3g %.3g %.3g %.3g %.3g %.3g ',material_name,' ',ds_char,' \n'],[xlims(1) ylims(1) vals(3)-depth_to_top-thickness-50 xlims(2) ylims(2) vals(3)-depth_to_top-50]);
